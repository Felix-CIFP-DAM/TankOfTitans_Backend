...
class GameTimer {
    constructor(partidaId, onSave, onEnd, onTurnEnd) {
        ...
        if (typeof onTurnEnd !== 'function') throw new Error('GameTimer: onTurnEnd debe ser una función');
        this.partidaId = partidaId;
        this.timeLeft = GAME_DURATION;
        this.turnTimeLeft = TURN_DURATION;
        this.onSave = onSave; // función que llama a la API para guardar estado
        this.onEnd = onEnd;   // función que se llama al acabar la partida
        this.onTurnEnd = onTurnEnd; // función que se llama al acabar el turno
        this.interval = null;
    }
    ...
    getTimeLeft() {
        return { total: this.timeLeft, turno: this.turnTimeLeft };
    }
}
